...
class JacksonSerializedSudokuGameStateTest {
    private val expectedString = """{"difficulty":"EASY","playedTime":"00:00:30","numberOfTurns":3,"gameIsWon":false,"tableState":{"cells":[{"value":1,"coordinateX":1,"coordinateY":1,"cellIsOpen":true},{"value":2,"coordinateX":1,"coordinateY":2,"cellIsOpen":false}],"conflicts":[],"tableIsFull":false,"tableIsEmpty":false}}"""
    ...
    fun turnsGivenGameStateToValidJsonString() {
        val tableState = TableState(
            ...
            listOf(), false, false)
        val gameState = GameState( SudokuDifficulty.EASY, "00:00:30", 3, false, tableState)
