...
class JacksonDeserializedSudokuGameTest {
    ...
    fun correctlyCreatesGameStateFromJson() {
        val json = """{"gameId":"1","playedTime":"00:00:30","numberOfTurns":3,"gameIsWon":false,"tableState":{"cells":[{"value":1,"coordinates":{"x":1,"y":1},"cellIsOpen":true},{"value":2,"coordinates":{"x":1,"y":2},"cellIsOpen":false}],"conflicts":[],"tableIsEmpty":false,"tableIsFull":false}}"""
